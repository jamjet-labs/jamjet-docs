...
- **强制限制** — `max_iterations`、`max_cost_usd`、`timeout_seconds` 是一等参数

无样板代码。无状态类。无依赖注入。

> **注意:** 
需要完整的图控制 — 多步骤流水线、条件路由、人工介入?
...
**需要帮助？** 在 [GitHub Discussion](https://github.com/jamjet-labs/jamjet/discussions) 中提问或[提交 issue](https://github.com/jamjet-labs/jamjet/issues)。
