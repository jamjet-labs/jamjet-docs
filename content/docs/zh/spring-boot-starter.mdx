...
<dependencies>
    ...
    <!-- Spring Boot Actuator（启用 Micrometer 指标）-->
    <dependency>
...
| Spring Boot | 3.4+ |
| Spring AI | 1.0+ |
| JamJet runtime | 0.3.1+（Docker 或二进制文件）|
...
- **[Java SDK 参考](/java-sdk)** --- 完整的 API 覆盖，包括工具、策略、IR 编译和运行时客户端
- **[Java 快速入门](/java-quickstart)** --- 使用 Java SDK 从零构建你的第一个智能体和工作流
- **[核心概念](/concepts)** --- 深入了解智能体、节点、状态和持久化
- **[智能体 AI 模式](https://sunilprakash.com/agentic-ai)** --- 策略选择、工具设计以及智能体系统的生产级模式
