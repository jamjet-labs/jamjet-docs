...
- **Release filter**: useful for tracking regressions after a deploy. Compare cost and error rates between two `releaseVersion` values on the Runs and Costs surfaces.
...
<Cards>
  ...
  <Card title="Runs" href="/cloud/telemetry/spans-and-traces" description="Filter by environment and release in the dashboard." />
</Cards>
