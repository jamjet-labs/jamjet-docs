...
JamJet implementa el [protocolo Agent-to-Agent (A2A)](https://google.github.io/A2A/) — un estándar abierto para que los agentes se descubran, se llamen y colaboren entre sí a través de frameworks y organizaciones.
