...
For chat memory, see [Engram](/open-source/engram) — JamJet's temporal-knowledge-graph memory layer with first-class Spring Boot integration via `engram-spring-boot-starter`.
