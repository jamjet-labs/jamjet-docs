...
Ejecuta experimentos multi-agente reproducibles sin construir infraestructura de experimentación personalizada. JamJet te proporciona ejecución duradera, barridos de estrategias, reproducción, evaluación y exportación lista para publicación en un único runtime.

Esta guía recorre un flujo de trabajo de investigación completo — desde el scaffold del proyecto hasta resultados listos para papers.

> **Consejo:** 
¿Ya conoces JamJet? Salta a [Ejecutar experimentos](#run-experiments) o [Exportar para publicación](#export-for-publication).

> **Cuándo usar flujos de trabajo de investigación de JamJet:**
> - Comparar estrategias de razonamiento entre modelos y seeds
> - Ejecutar barridos de parámetros con recolección automática de resultados
> - Reproducir condiciones fallidas o interesantes desde checkpoints
> - Exportar resultados para un paper (LaTeX, CSV, JSON con tests de significancia)
> - Conectar un experimento a un flujo de trabajo de producción más adelante
