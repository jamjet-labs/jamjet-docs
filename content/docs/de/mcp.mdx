...
> **Wesentlicher Unterschied:** JamJet behandelt MCP-Tool-Aufrufe als Teil eines dauerhaften Workflows, nicht nur als flüchtige Tool-Invocations. Das bedeutet, dass die Tool-Nutzung checkpointfähig, wiederholbar und beobachtbar bleibt — selbst wenn der Prozess während des Aufrufs abstürzt.
...
- [Quickstart](/docs/quickstart) — führe zunächst einen Workflow aus
- [A2A-Integration](/docs/a2a) — delegiere Aufgaben an andere Agenten
- [Showcase](https://jamjet.dev/showcase) — sieh dir MCP-Muster in Produktionsbeispielen an
