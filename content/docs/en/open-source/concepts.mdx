...
| **Python decorator API** | Custom logic, Python library access | Dict-based `State` | [Python SDK docs](/open-source/python-runtime) |
...
Every agent has an **Agent Card** — a machine-readable description of its capabilities, endpoints, and input/output schema. This is the foundation for the [A2A protocol](/open-source/protocols/a2a).
...
- [Quickstart](/open-source/quickstart) — build your first durable agent
- [Python SDK](/open-source/python-runtime) — decorators, routing, parallel steps
- [Try crash recovery](/open-source/quickstart) — see durability in action
