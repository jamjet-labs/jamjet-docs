...
- Browse [research examples](https://jamjet.dev/showcase) — DCI deliberation and LDP routing patterns
- See the [/research](https://jamjet.dev/research) page for capabilities overview
- Read the [eval harness docs](/open-source/research/eval) for deeper eval configuration
