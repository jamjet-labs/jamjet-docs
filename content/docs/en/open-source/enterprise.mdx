...
JamJet provides runtime-enforced controls for teams that need reliability and governance together: tenant isolation, PII redaction, scoped OAuth delegation, mTLS federation, and retention-aware execution logs.

Enforced at the Rust runtime layer — not by convention, and not by middleware you might forget to add.

> **Best for:**
> - Regulated internal platforms
> - Multi-tenant agent infrastructure
> - Audit-heavy enterprise workflows
> - Teams that need replay, traces, and policy controls together
...
```bash
git clone https://github.com/jamjet-labs/jamjet-examples examples
...
> **tip:** 
Read the full deep dives: [data governance and PII redaction](https://jamjet.dev/blog/data-governance-pii-retention/), [OAuth delegation and federation auth](https://jamjet.dev/blog/oauth-federation-agent-auth/).
